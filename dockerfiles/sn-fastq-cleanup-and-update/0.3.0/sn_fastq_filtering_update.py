...
def parse_args():
    ...
    parser.add_argument('--corrected', required=True, help='Corrected barcodes FASTQ file')
    parser.add_argument('--unmatched', required=True, help='Text file with unmatched barcodes')
    parser.add_argument('--out_r1', required=True, help='Filtered R1 FASTQ file ')
    parser.add_argument('--out_r2', required=True, help='Filtered R2 FASTQ file ')
...
if __name__ == "__main__":
    ...
    # processing 
    with open(r1_in) as r1_f, open(r2_in) as r2_f, open(bc_in) as bc_f, \
        open(r1_out, "w") as out1, open(r2_out, "w") as out2:
