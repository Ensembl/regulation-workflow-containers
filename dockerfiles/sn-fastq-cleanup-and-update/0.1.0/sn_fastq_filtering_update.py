"""
Parallel FASTQ update and filtering for single-nucleus experiments.
Processes R1, R2, R3 files simultaneously correcting barcodes and 
removing reads with invalid barcodes detected using the
barcodes_correction.py script
"""
...
## -- Arguments parser --
def parse_args():
    parser = argparse.ArgumentParser(description='Update single-nucleus FASTQ files based on barcode correction')
    ...
    parser.add_argument('--unmatched', required=True, help='Text file listing unmatched barcodes')
